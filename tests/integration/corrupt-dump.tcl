...
test {corrupt payload: zipmap rejects five-byte encoding for a small field} {
...
test {corrupt payload: zipmap rejects five-byte encoding for a small value} {
    start_server [list overrides [list loglevel verbose use-exit-on-panic yes crash-memcheck-enabled no]] {
        catch {
...
test {corrupt payload: stream rejects a duplicated consumer PEL entry} {
    start_server [list overrides [list loglevel verbose use-exit-on-panic yes crash-memcheck-enabled no]] {
